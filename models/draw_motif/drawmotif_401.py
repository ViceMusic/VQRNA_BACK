...
from motifmodel.motifmodel_401 import Lucky
...
def load_model_and_data():
    ...
    model.load_state_dict(torch.load(f"../save/length/length401/data{params['data_index']}/seed{params['seed']}.pth")['state_dict'])
...
for i in range(len(test_dataset)):
    ...
    X_attr5 = saturation_mutagenesis(wrapper.cpu(), x.cpu(), start=0, end=400, device='cpu')
...
avg_attr6 = abs(total_attr5) / len(test_dataset)
