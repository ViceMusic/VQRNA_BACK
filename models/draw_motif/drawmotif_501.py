...
from motifmodel.motifmodel_501 import Lucky
...
def load_model_and_data():
    ...
    model.load_state_dict(torch.load(f"../save/length/length501/data{params['data_index']}/seed{params['seed']}.pth")['state_dict'])
