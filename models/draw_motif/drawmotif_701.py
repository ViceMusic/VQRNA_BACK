...
from motifmodel.motifmodel_701 import Lucky
...
def load_model_and_data():
    ...
    model.load_state_dict(torch.load(f"../save/length/length701/data{params['data_index']}/seed{params['seed']}.pth")['state_dict'])
...
for i in range(len(test_dataset)):
    ...
    X_attr8 = saturation_mutagenesis(wrapper.cpu(), x.cpu(), start=0, end=700, device='cpu')
...
importance_score = torch.sum(avg_attr8, dim=1)
