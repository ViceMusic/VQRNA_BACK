...
from motifmodel.motifmodel_901 import Lucky
...
def load_model_and_data():
    ...
    model.load_state_dict(torch.load(f"../save/length/length901/data{params['data_index']}/seed{params['seed']}.pth")['state_dict'])
...
for i in range(len(test_dataset)):
    ...
    X_attr10 = saturation_mutagenesis(wrapper.cpu(), x.cpu(), start=0, end=900, device='cpu')
...
importance_score = torch.sum(avg_attr10, dim=1)
